...
def build_profile(
    ...
    return {
        ...
        "draught_current_m": current,
        "draught_max_seen_m": max_seen,
        "draught_min_seen_m": min_seen,
        "draught_sample_count": sample_count,
        "draught_laden_ratio": config.VESSEL_DRAUGHT_LADEN_RATIO,
        "draught_ballast_ratio": config.VESSEL_DRAUGHT_BALLAST_RATIO,
        "draught_min_samples": config.VESSEL_DRAUGHT_MIN_SAMPLES,
